        ...
        <div className="flex flex-col -ml-10 ">
          <div className="flex pl-[300px]">
            <div
              ...
              data-aos-easing="ease-in-out"
              className="border border-black border-r-0  rounded-tl-[42px] flex  flex-col justify-between  p-4 w-[300px] h-[300px]"
            >
              <h2>General</h2>
              <p>
            ...
            <div
              ...
              data-aos-duration="500"
              data-aos-easing="ease-in-out"
              className="border border-black rounded-tr-[42px]   flex  flex-col justify-between p-4 w-[300px] h-[300px]"
            >
          ...
          <div>
            <div className="flex">
              ...
              <div
                ...
                data-aos-duration="500"
                data-aos-easing="ease-in-out"
                className="border bg-white border-black border-r-0 rounded-tl-[42px]  rounded-bl-[42px]  flex  flex-col justify-between  p-4 w-[300px] h-[300px]"
              >
              ...
              <div
                ...
                data-aos-duration="500"
                data-aos-easing="ease-in-out"
                className="border border-black  border-r-0 border-t-0   flex  flex-col justify-between p-4 w-[300px] h-[300px]"
              >
              ...
              <div
                ...
                data-aos-duration="500"
                data-aos-easing="ease-in-out"
                className="border bg-black border-black rounded-br-[42px]  flex  flex-col justify-between p-4 w-[300px] h-[300px]"
              >
